...
export const DEFAULT_VIDEOS: VideoItem[] = [
  { id:"v1",title:"La Caída del Imperio Romano — Parte 3",description:"",tags:["historia","roma","imperio"],channel:"ch1",status:"rendering",progress:78,duration:"0:45",scheduledAt:"Hoy 18:00",views:0,estimatedViews:"12K",createdAt:"2026-02-28" },
  ...
  { id:"v3",title:"10 Datos del Océano que No Sabías",description:"",tags:["ciencia","oceano","datos"],channel:"ch3",status:"generating",progress:34,duration:"0:30",scheduledAt:"Mañana 10:00",views:0,estimatedViews:"8K",createdAt:"2026-02-28" },
  { id:"v4",title:"El Misterio de la Isla Perdida",description:"",tags:["misterio","terror","leyenda"],channel:"ch4",status:"script",progress:12,duration:"0:55",scheduledAt:"Mañana 14:00",views:0,estimatedViews:"5K",createdAt:"2026-02-28" },
  { id:"v5",title:"La Revolución Francesa Explicada",description:"",tags:["historia","francia","revolución"],channel:"ch1",status:"complete",progress:100,duration:"0:50",scheduledAt:"Publicado",views:34200,estimatedViews:"30K",createdAt:"2026-02-27",publishedAt:"2026-02-27" },
  { id:"v6",title:"Aprende los Números Cantando",description:"",tags:["niños","números","canción"],channel:"ch2",status:"voiceover",progress:56,duration:"0:40",scheduledAt:"Mañana 08:00",views:0,estimatedViews:"52K",createdAt:"2026-02-28" },
  { id:"v7",title:"¿Por qué el Cielo es Azul?",description:"",tags:["ciencia","cielo","curiosidad"],channel:"ch3",status:"compositing",progress:67,duration:"0:25",scheduledAt:"Mañana 12:00",views:0,estimatedViews:"11K",createdAt:"2026-02-28" },
  { id:"v8",title:"Animales de la Selva para Niños",description:"",tags:["niños","animales","selva"],channel:"ch2",status:"thumbnail",progress:88,duration:"0:35",scheduledAt:"Hoy 21:00",views:0,estimatedViews:"38K",createdAt:"2026-02-28" },
  { id:"v9",title:"Nunca Renuncies a tus Sueños",description:"",tags:["motivación","éxito","superación"],channel:"ch5",status:"complete",progress:100,duration:"0:45",scheduledAt:"Publicado",views:67800,estimatedViews:"50K",createdAt:"2026-02-27",publishedAt:"2026-02-27" },
  { id:"v10",title:"IA que Cambiará Todo en 2026",description:"",tags:["tecnología","IA","futuro"],channel:"ch6",status:"rendering",progress:71,duration:"0:55",scheduledAt:"Hoy 22:00",views:0,estimatedViews:"15K",createdAt:"2026-02-28" },
  { id:"v11",title:"5 Imperios que Desaparecieron",description:"",tags:["historia","imperios","misterio"],channel:"ch1",status:"generating",progress:45,duration:"0:40",scheduledAt:"Mañana 16:00",views:0,estimatedViews:"18K",createdAt:"2026-02-28" },
  { id:"v12",title:"Canciones Infantiles — Arcoíris",description:"",tags:["niños","canciones","arcoíris"],channel:"ch2",status:"script",progress:5,duration:"0:50",scheduledAt:"Pasado 08:00",views:0,estimatedViews:"60K",createdAt:"2026-02-28" },
  { id:"v13",title:"El Hombre Polilla: Caso Real",description:"",tags:["terror","criptozoología","misterio"],channel:"ch4",status:"voiceover",progress:48,duration:"0:50",scheduledAt:"Mañana 20:00",views:0,estimatedViews:"9K",createdAt:"2026-02-28" },
  { id:"v14",title:"Mentalidad de Tiburón",description:"",tags:["motivación","negocios","mentalidad"],channel:"ch5",status:"compositing",progress:72,duration:"0:35",scheduledAt:"Hoy 23:00",views:0,estimatedViews:"22K",createdAt:"2026-02-28" },
  { id:"v15",title:"Robots que ya Existen en 2026",description:"",tags:["tecnología","robots","futuro"],channel:"ch6",status:"script",progress:8,duration:"0:45",scheduledAt:"Mañana 18:00",views:0,estimatedViews:"20K",createdAt:"2026-02-28" },
]
